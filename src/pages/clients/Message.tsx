...
const Message = () => {
    return (
        <div className="box-message bg-white flex-1 justify-between flex flex-col h-screen">
            ...
            <div 
                id="messages"
                className=" flex flex-col space-y-4 p:2 sm:p-4 overflow-y-auto scrollbar-thumb-blue scrollbar-thumb-rounded scrollbar-track-blue-lighter scrollbar-w-2 scrolling-touch"
            >
            ...
            <div className="border-t-[1px] py-2">
                <div className="relative flex px:2 sm:px-4">
                    ...
                    <input
                        ...
                        className="w-full focus:outline-none focus:placeholder-gray-200 text-gray-600 placeholder-gray-400 pl-12 bg-gray-200 rounded-lg py-2 border-[1px] border-[#bebebe]"
                    />
